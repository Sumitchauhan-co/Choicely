            ...
            <div className="flex flex-col space-y-4">
                <div className="flex flex-col gap-3 text-xs sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex max-w-[70%] items-center gap-2.5">
                        <div className="bg-primary/10 text-primary border-primary/20 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border text-xs font-bold tracking-wider uppercase select-none">
                            {creator?.firstName
                        ...
                        {poll.name && (
                            <div className="bg-secondary text-secondary-foreground border-border/60 inline-flex max-w-[100px] items-center gap-1 truncate rounded-md border px-2 py-0.5 select-none sm:max-w-[140px]">
